...
function getWinners(data, getFinalsCB) {
    return getFinalsCB(data).map(item => item['Home Team Goals'] > item['AwayTeam Goals'] ? item['Home Team Name'] : item['Away Team Name']);
}
...
function getAverageGoals(data) {
    const averageHomeGoals = data.reduce(function(accumlater, item){
        return accumlater + item['Home Team Goals'] + item['Away Team Goals'];
    }, 0)
